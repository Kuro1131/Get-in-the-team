...
public class GoldenBandageItem extends Item{
    public GoldenBandageItem(Item.Properties pProperties) {
        super(pProperties);
    }
    ...
    public void appendHoverText(ItemStack p_41421_, @Nullable Level p_41422_, List<Component> p_41423_, TooltipFlag p_41424_) {
        p_41423_.add(Component.translatable("tooltip.getintheteam.golden_bandage.tooltip"));
